  ...
  $$renderer.component(($$renderer2) => {
    ...
    });
    {
      let controls = function($$renderer3) {
        ...
        $$renderer3.push(`<div class="negotiation-layout svelte-1t9n1vv"><div class="controls-row svelte-1t9n1vv">`);
        ...
        $$renderer3.push(`<!----></div> <div class="topic-card svelte-1t9n1vv"><h3 class="svelte-1t9n1vv">${escape_html(negotiationTopic.title)}</h3> <p class="svelte-1t9n1vv">${escape_html(negotiationTopic.description)}</p> <div class="stakes-grid svelte-1t9n1vv"><div class="stake-item svelte-1t9n1vv"><span class="stake-label svelte-1t9n1vv">Employee</span> <span class="stake-value svelte-1t9n1vv">${escape_html(negotiationTopic.stakes.employee)}</span></div> <div class="stake-item svelte-1t9n1vv"><span class="stake-label svelte-1t9n1vv">Manager</span> <span class="stake-value svelte-1t9n1vv">${escape_html(negotiationTopic.stakes.manager)}</span></div> <div class="stake-item svelte-1t9n1vv"><span class="stake-label svelte-1t9n1vv">Organization</span> <span class="stake-value svelte-1t9n1vv">${escape_html(negotiationTopic.stakes.organization)}</span></div></div></div> <div class="arena-section svelte-1t9n1vv">`);
        ...
        if (showPrivateContext) {
          $$renderer3.push("<!--[-->");
          $$renderer3.push(`<div class="learning-section svelte-1t9n1vv"><h3 class="svelte-1t9n1vv"><i class="fa-solid fa-graduation-cap" aria-hidden="true"></i> Key Insights</h3> <ul class="learning-points svelte-1t9n1vv"><!--[-->`);
