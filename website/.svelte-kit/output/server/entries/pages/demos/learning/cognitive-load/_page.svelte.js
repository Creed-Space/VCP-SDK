import { a1 as attr_class, a0 as attr, a6 as attr_style, a3 as escape_html, a7 as stringify, a8 as ensure_array_like, a2 as head } from "../../../../../chunks/index2.js";
  ...
  $$renderer.component(($$renderer2) => {
    ...
    function applyPreset(preset) {
      loadState = {
        ...loadState,
        ...preset.data,
        last_break: preset.id === "fresh-start" ? (/* @__PURE__ */ new Date()).toISOString() : new Date(Date.now() - preset.data.session_duration_minutes * 60 * 1e3).toISOString(),
    ...
    });
    {
      let children = function($$renderer3) {
        ...
        $$renderer3.push(`<!----> `);
        AuditPanel($$renderer3, { entries: auditEntries, title: "Cognitive State Audit" });
        $$renderer3.push(`<!----> <div class="adaptations-card svelte-15t7dss"><h3 class="svelte-15t7dss">Active Adaptations</h3> <div class="adaptations-list svelte-15t7dss"><!--[-->`);
