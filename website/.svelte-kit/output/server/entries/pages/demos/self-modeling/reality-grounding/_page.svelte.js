import { a2 as head, a8 as ensure_array_like, a1 as attr_class, a0 as attr, a3 as escape_html, a6 as attr_style, a7 as stringify } from "../../../../../chunks/index2.js";
...
function _page($$renderer) {
  ...
  const groundingTypeInfo = {
    ...
    normative: {
      icon: '<i class="fa-solid fa-scale-balanced" aria-hidden="true"></i>',
      label: "Normative",
    ...
    let children = function($$renderer2) {
      ...
      for (let i = 0, $$length = each_array.length; i < $$length; i++) {
        ...
        if (grounding.uncertainty_markers.length > 0) {
          $$renderer2.push("<!--[-->");
          $$renderer2.push(`<div class="uncertainty-markers svelte-gdbgrd"><span class="uncertainty-label svelte-gdbgrd"><i class="fa-solid fa-triangle-exclamation" aria-hidden="true"></i> Uncertainty:</span> <!--[-->`);
        ...
        if (grounding.should_verify) {
          $$renderer2.push("<!--[-->");
          $$renderer2.push(`<div class="verify-notice svelte-gdbgrd"><span class="verify-icon"><i class="fa-solid fa-magnifying-glass" aria-hidden="true"></i></span> <span>This claim should be verified before acting on it</span></div>`);
        } else {
          $$renderer2.push("<!--[!-->");
        }
        $$renderer2.push(`<!--]--> `);
