...
as passes. WebMCP capability-negotiation, context-encoding, and relational
behavior vectors run through the declared cross-runtime conformance runners. Separately, the packed
