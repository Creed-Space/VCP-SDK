...
- [VCP Specification](../specs/VCP_SPECIFICATION_CANONICAL.md)
- Historical integration contprompt (not distributed in this SDK)
- Application-owned feature flag service
