...
| 5.1 | MCP Script | ✅ | packaged `vcp-mcp-server` entry point |
...
| Document | Description |
|----------|-------------|
| [Canonical VCP specification](../specs/VCP_SPECIFICATION_CANONICAL.md) | Full transport protocol |
...
- Torch system: operator-owned Interiora torch system documentation
- Quick reference: [VCP torch architecture](VCP_TORCH_ARCHITECTURE.md)
