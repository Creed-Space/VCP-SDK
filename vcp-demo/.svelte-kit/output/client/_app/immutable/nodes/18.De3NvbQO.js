...
}`,t(o);var i=e(o,4),A=n(i);A.textContent=`interface ConstitutionReference {
...
}`,t(i);var a=e(i,4),E=n(a);E.textContent=`interface PublicProfile {
  display_name?: string;
  goal?: string;
...
}`,t(c);var p=e(c,8),F=n(p);F.textContent=`import { encodeContextToCSM1 } from '@creed-space/vcp';
...
// P:muse:3
// ...`,t(p);var l=e(p,14),V=n(l);V.textContent=`import { formatTokenForDisplay } from '@creed-space/vcp';
...
// │ VCP:1.0:user_001                       │
// │ ...                                    │
// └────────────────────────────────────────┘`,t(l);var h=e(l,6),L=n(h);L.textContent=`import { parseCSM1Token } from '@creed-space/vcp';
...
//   P: "muse:3",
//   ...
// }`,t(h);var m=e(h,8),D=n(m);D.textContent=`import { getEmojiLegend } from '@creed-space/vcp';
...
//   ...
// ]`,t(m);var _=e(m,6),j=n(_);j.textContent=`import { getTransmissionSummary } from '@creed-space/vcp';
...
// }`,t(_);var u=e(_,8),q=n(u);q.textContent=`const CONSTRAINT_EMOJI = {
  noise_restricted: '🔇',
  budget_limited: '💰',
  energy_variable: '⚡',
  time_limited: '⏰',
...
}`,t(u);var g=e(u,4),N=n(g);N.textContent=`const PRIVATE_MARKER = '🔒';
const SHARED_MARKER = '✓';`,t(g);var f=e(g,30),O=n(f);O.textContent=`type ScopeType = 'work' | 'education' | 'creativity' | 'health' | 'privacy'
  | 'family' | 'finance' | 'social' | 'legal' | 'safety';`,t(f);var v=e(f,6),K=n(v);K.textContent=`interface AuditEntry {
  id: string;
...
}`,t(P),W(4),S(r,b)},$$slots:{default:!0}})}export{oe as component};
