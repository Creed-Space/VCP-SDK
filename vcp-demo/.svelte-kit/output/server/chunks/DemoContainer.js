...
function DemoContainer($$renderer, $$props) {
  ...
  if (showTokenInspector && context) {
    $$renderer.push("<!--[-->");
    $$renderer.push(`<button${attr_class("control-btn svelte-1pzj3u", void 0, { "active": tokenInspectorOpen })}><span class="control-icon svelte-1pzj3u">🔍</span> <span>Token</span></button>`);
  } else {
    $$renderer.push("<!--[!-->");
  }
  $$renderer.push(`<!--]--> `);
  if (showAuditTrail) {
    $$renderer.push("<!--[-->");
    $$renderer.push(`<button${attr_class("control-btn svelte-1pzj3u", void 0, { "active": auditTrailOpen })}><span class="control-icon svelte-1pzj3u">📋</span> <span>Audit</span></button>`);
  } else {
    $$renderer.push("<!--[!-->");
  }
  $$renderer.push(`<!--]--> `);
