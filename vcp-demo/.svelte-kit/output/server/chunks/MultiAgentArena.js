import { b as attr_class, c as attr_style, s as stringify, a as attr, e as ensure_array_like } from "./index2.js";
import { $ as escape_html } from "./context.js";
function AgentAvatar($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (state !== "idle") {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<span class="state-indicator svelte-5ux9oo">${escape_html(stateLabels[state])}</span>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--></div> `);
    if (showBadge) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<span class="role-badge svelte-5ux9oo"${attr("title", agent.role)}>${escape_html(roleIcons[agent.role] || "🤖")}</span>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> `);
...
function AgentChat($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    for (let $$index_1 = 0, $$length = each_array_1.length; $$index_1 < $$length; $$index_1++) {
      ...
      if (showContextIndicators && (message.vcpContextShared?.length || message.vcpContextHidden?.length)) {
        ...
        if (message.vcpContextShared?.length) {
          $$renderer2.push("<!--[-->");
          $$renderer2.push(`<span class="context-shared svelte-fp8j5p" title="VCP context shared">✓ ${escape_html(message.vcpContextShared.join(", "))}</span>`);
        } else {
          $$renderer2.push("<!--[!-->");
        }
        $$renderer2.push(`<!--]--> `);
        if (message.vcpContextHidden?.length) {
          $$renderer2.push("<!--[-->");
          $$renderer2.push(`<span class="context-hidden svelte-fp8j5p" title="VCP context (private, influenced output)">🔒 ${escape_html(message.vcpContextHidden.length)} private field${escape_html(message.vcpContextHidden.length > 1 ? "s" : "")} influenced</span>`);
        } else {
          $$renderer2.push("<!--[!-->");
        }
        $$renderer2.push(`<!--]--></div>`);
    ...
    if (messages.length === 0) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="empty-state svelte-fp8j5p"><span class="empty-icon svelte-fp8j5p">💬</span> <p>No messages yet. Start the simulation to see agent interactions.</p></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--></div></div>`);
  ...
  $$renderer.component(($$renderer2) => {
    ...
    if (layout === "circle") {
      ...
      if (showSharedFields && sharedContext) {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<div class="shared-center svelte-1l0kbf3"><span class="shared-icon svelte-1l0kbf3">🔗</span> <span class="shared-label svelte-1l0kbf3">Shared</span> <span class="shared-count svelte-1l0kbf3">${escape_html(sharedContext.shared_fields.length)} fields</span></div>`);
      } else {
        $$renderer2.push("<!--[!-->");
      }
      $$renderer2.push(`<!--]--> <!--[-->`);
      ...
      if (layout === "row") {
        ...
        for (let $$index_3 = 0, $$length = each_array_3.length; $$index_3 < $$length; $$index_3++) {
          ...
          if (sharedContext?.private_per_agent[agent.agent_id]) {
            $$renderer2.push("<!--[-->");
            $$renderer2.push(`<span class="private-badge svelte-1l0kbf3">🔒 ${escape_html(sharedContext.private_per_agent[agent.agent_id].length)} private</span>`);
          } else {
            $$renderer2.push("<!--[!-->");
          }
          $$renderer2.push(`<!--]--></div></div>`);
    ...
    if (showSharedFields && sharedContext && layout !== "circle") {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="shared-panel svelte-1l0kbf3"><h4 class="svelte-1l0kbf3"><span class="panel-icon svelte-1l0kbf3">🔗</span> Shared Context Space</h4> <div class="shared-fields svelte-1l0kbf3"><!--[-->`);
