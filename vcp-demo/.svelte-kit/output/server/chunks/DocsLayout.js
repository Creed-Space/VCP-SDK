import { d as store_get, a as attr, b as attr_class, e as ensure_array_like, u as unsubscribe_stores } from "./index2.js";
import { _ as getContext, $ as escape_html } from "./context.js";
import "clsx";
...
function DocsLayout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="docs-layout svelte-fxrvrl"><button class="sidebar-toggle svelte-fxrvrl"${attr("aria-expanded", sidebarOpen)} aria-controls="docs-sidebar"><span class="toggle-icon svelte-fxrvrl">${escape_html("☰")}</span> <span class="toggle-text">Menu</span></button> <aside id="docs-sidebar"${attr_class("sidebar svelte-fxrvrl", void 0, { "open": sidebarOpen })}><nav class="sidebar-nav" aria-label="Documentation navigation"><a href="/docs"${attr_class("sidebar-home svelte-fxrvrl", void 0, { "active": currentPath === "/docs" })}><span class="home-icon svelte-fxrvrl">📚</span> Documentation Home</a> <!--[-->`);
