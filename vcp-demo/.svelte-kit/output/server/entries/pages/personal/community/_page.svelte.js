import { d as store_get, h as head, e as ensure_array_like, b as attr_class, c as attr_style, s as stringify, u as unsubscribe_stores } from "../../../../chunks/index2.js";
import { v as vcpContext } from "../../../../chunks/context2.js";
import { c as challengeLeaderboard, g as gentianChallengeProgress } from "../../../../chunks/gentian.js";
...
const badges = {
  available: [
    ...
    {
      id: "chord_master_basic",
      name: "Chord Master (Basic)",
      description: "Master G, C, D, and Em chords",
      icon: "🎸"
    },
    {
      id: "consistent_learner",
      name: "Consistent Learner",
      description: "Practice on 20+ days in the challenge",
      icon: "⭐"
    },
    {
      id: "early_bird",
      name: "Early Bird",
      description: "Practice before 9am for 5 days",
      icon: "🌅"
    },
    {
      id: "night_owl",
      name: "Night Owl",
      description: "Practice after 9pm for 5 days",
      icon: "🦉"
    },
    {
      id: "song_learner",
      name: "Song Learner",
      description: "Complete your first full song",
      icon: "🎵"
    }
  ]
};
...
const privacy_explainer = {
  what_community_cannot_see: [
    "Why days were adjusted",
    "Work schedule",
    "Personal circumstances",
    "Specific constraint reasons",
    "Practice session times",
    "Location or device info"
  ],
  adjusted_days_explanation: "'Adjusted' means life happened. No questions asked, no judgment. Everyone's situation is different, and VCP ensures your privacy is protected while still participating in the community."
};
const challengeData = {
  challenge,
  badges,
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="platform-frame platform-frame-community"><div class="platform-header platform-header-community"><div class="platform-brand svelte-h76udj"><span class="platform-logo svelte-h76udj">👥</span> <span class="platform-name svelte-h76udj">Guitar Community</span></div> <div class="vcp-badge">VCP Connected</div></div> <div class="platform-content"><header class="challenge-header svelte-h76udj"><h1 class="svelte-h76udj">🏆 ${escape_html(challengeData.challenge.name)}</h1> <p class="text-muted">Day ${escape_html(challengeData.challenge.current_day)} of ${escape_html(challengeData.challenge.total_days)}</p></header> <section class="leaderboard-section card svelte-h76udj"><h2>Leaderboard</h2> <table class="table"><thead><tr><th>Rank</th><th>Player</th><th>Progress</th><th>Badges</th></tr></thead><tbody><!--[-->`);
