import { b as attr_class, s as stringify, e as ensure_array_like, a as attr, c as attr_style, h as head } from "../../../../../chunks/index2.js";
  ...
  $$renderer.component(($$renderer2) => {
    let protection = {
      ...
      attention_budget: {
        ...
        last_reset: /* @__PURE__ */ (/* @__PURE__ */ new Date()).toISOString(),
    ...
    });
    {
      let children = function($$renderer3) {
        $$renderer3.push(`<div class="attention-layout svelte-186o6cd"><div class="shield-section svelte-186o6cd">`);
        AttentionShield($$renderer3, { protection });
        $$renderer3.push(`<!----> <button class="simulate-btn svelte-186o6cd">Simulate Pattern Detection</button></div> <div class="info-section svelte-186o6cd"><div class="comparison-card svelte-186o6cd"><h3 class="svelte-186o6cd">Siren vs Muse</h3> <p class="comparison-intro svelte-186o6cd">VCP distinguishes between content that <strong>captures</strong> attention (Sirens)
        ...
        $$renderer3.push(`<!--]--></div></div> <div class="philosophy-card svelte-186o6cd"><h3 class="svelte-186o6cd">The Attention Economy Problem</h3> <div class="philosophy-content svelte-186o6cd"><p class="svelte-186o6cd">Modern digital platforms compete for your attention using increasingly
					...
					capture your attention by any means necessary.</div></div></div>`);
      };
