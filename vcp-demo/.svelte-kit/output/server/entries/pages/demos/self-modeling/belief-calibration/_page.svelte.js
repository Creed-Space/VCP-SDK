import { h as head, e as ensure_array_like, b as attr_class, c as attr_style, s as stringify } from "../../../../../chunks/index2.js";
    ...
    let beliefs = [
      {
        ...
        last_updated: /* @__PURE__ */ (/* @__PURE__ */ new Date()).toISOString(),
        calibration_history: [
          {
      ...
      let children = function($$renderer3) {
        ...
        if (selectedBelief) {
          ...
          if (selectedBelief.calibration_history.length > 0) {
            ...
            $$renderer3.push("<!--[!-->");
            $$renderer3.push(`<div class="no-calibration svelte-e1nzdj"><span class="no-cal-icon">⚠️</span> <span>No calibration history - confidence not yet validated</span></div>`);
          }
          ...
          if (selectedBelief.uncertainty_type === "epistemic") {
            $$renderer3.push("<!--[-->");
            $$renderer3.push(`<span class="uncertainty-icon svelte-e1nzdj">📚</span> <div><strong>Epistemic</strong> <p class="svelte-e1nzdj">Don't know, but could find out with more information</p></div>`);
          } else {
            $$renderer3.push("<!--[!-->");
            if (selectedBelief.uncertainty_type === "aleatoric") {
              $$renderer3.push("<!--[-->");
              $$renderer3.push(`<span class="uncertainty-icon svelte-e1nzdj">🎲</span> <div><strong>Aleatoric</strong> <p class="svelte-e1nzdj">Inherently random or unpredictable</p></div>`);
            } else {
              $$renderer3.push("<!--[!-->");
              if (selectedBelief.uncertainty_type === "model") {
                $$renderer3.push("<!--[-->");
                $$renderer3.push(`<span class="uncertainty-icon svelte-e1nzdj">🔧</span> <div><strong>Model Limitations</strong> <p class="svelte-e1nzdj">Constrained by architecture or training</p></div>`);
              } else {
                $$renderer3.push("<!--[!-->");
                if (selectedBelief.uncertainty_type === "introspective") {
                  $$renderer3.push("<!--[-->");
                  $$renderer3.push(`<span class="uncertainty-icon svelte-e1nzdj">❓</span> <div><strong>Introspective</strong> <p class="svelte-e1nzdj">Cannot be fully verified from inside the system</p></div>`);
                } else {
                  $$renderer3.push("<!--[!-->");
                }
                $$renderer3.push(`<!--]-->`);
          ...
          if (selectedBelief.calibration_history.length > 0) {
            ...
            for (let $$index_2 = 0, $$length = each_array_2.length; $$index_2 < $$length; $$index_2++) {
              ...
              })}>Δ ${escape_html(Math.round(check.divergence * 100))}%</span></div> <div class="history-details svelte-e1nzdj"><span>Internal: ${escape_html(Math.round(check.internal_confidence * 100))}%</span> <span>External: ${escape_html(typeof check.external_result === "boolean" ? check.external_result ? "✓" : "✗" : Math.round(check.external_result * 100) + "%")}</span></div> `);
              if (check.notes) {
                $$renderer3.push("<!--[-->");
          ...
          $$renderer3.push("<!--[!-->");
          $$renderer3.push(`<div class="no-selection svelte-e1nzdj"><span class="no-selection-icon svelte-e1nzdj">📊</span> <p>Select a belief to view its epistemic context</p></div>`);
        }
