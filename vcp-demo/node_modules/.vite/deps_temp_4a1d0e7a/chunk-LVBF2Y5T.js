...
traverse_effect_tree_fn = function(root, effects, render_effects) {
  ...
  while (effect !== null) {
    ...
    if (async_mode_flag && pending_boundary === null && (flags2 & BOUNDARY_EFFECT) !== 0 && ((_a = effect.b) == null ? void 0 : _a.is_pending)) {
    ...
    if (!skip && effect.fn !== null) {
      if (is_branch) {
        ...
        if ((flags2 & BLOCK_EFFECT) !== 0) __privateGet(this, _dirty_effects).add(effect);
...
//# sourceMappingURL=chunk-LVBF2Y5T.js.map
